"""
Utility: sql_formatter_utility
Location: my_main_project_folder/utils/sql_formatter_utility.py
Purpose: Format SQL queries with parameters for display and manual testing
"""
